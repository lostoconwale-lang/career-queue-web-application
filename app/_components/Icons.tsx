...
export function WhatsApp({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className={className}>
      <path d="M12 0a12 12 0 0 0-10.4 17.98L.2 24l6.2-1.62A12 12 0 1 0 12 0Zm0 21.82a9.78 9.78 0 0 1-4.99-1.37l-.36-.21-3.68.96.98-3.59-.24-.37A9.82 9.82 0 1 1 12 21.82Zm5.38-7.34c-.29-.15-1.73-.85-2-.95-.27-.1-.46-.15-.66.15-.2.29-.75.95-.92 1.15-.17.19-.34.22-.63.07-.29-.15-1.22-.45-2.32-1.43-.86-.76-1.44-1.71-1.61-2-.17-.29-.02-.44.13-.6.14-.14.32-.36.48-.55.16-.19.21-.32.32-.53.1-.2.05-.38-.04-.53-.1-.15-.63-1.52-.87-2.08-.23-.55-.47-.48-.65-.49-.17-.01-.36-.01-.55-.01-.19 0-.5.07-.76.36-.27.29-1.02 1-1.02 2.43s1.05 2.82 1.2 3.01c.15.19 2.01 3.06 4.87 4.17 2.86 1.1 2.86.74 3.38.69.52-.05 1.68-.68 1.92-1.35.24-.66.24-1.22.17-1.35-.08-.12-.28-.19-.57-.34Z" />
    </svg>
  );
}
...
export function GripDots({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className={className}>
